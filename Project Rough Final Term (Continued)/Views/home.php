...
<html>
    ...
    <body>
        <form method="post" action="../Controllers/loginCheck.php" enctype="" onsubmit="return checkNull()">
            <fieldset  >
                    ...
                    <tr>
                        <td>
                            <table align="center" border="1" width="400px" height="400px" >
                                ...
                                <tr align="center">
                                    <td colspan="2"><a href="Customer/customerRegistration.php"><b>Customer Registration</b></a></td>
                                </tr>
...
{ 
 // const form=document.getElementById("submissionForm");
  ...
  //form.addEventListener('Submit',(event)=>{
    ...
    alert("Log In failed, cannot take null values!"); event.preventDefault();  
