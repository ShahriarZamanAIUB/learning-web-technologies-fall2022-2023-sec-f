    ...
    echo "<tr><td style='background-color:#FFFFE0;'><hr></td></tr>";
                     ...
                     //   echo "<li><a href='editProfile.php'>Edit Profile</a></li>";
                        ...
                        echo "</tr>";
                           ...
                           $i=0;
                        $file=fopen('../../Assets/allFoods/'.$restaurantName.'/allFoodNames.txt','r');

                        if (filesize('../../Assets/allFoods/'.$restaurantName.'/allFoodNames.txt') == 0){header('location: customerChoosingRestaurant.php?err=food_menu_file_empty');}
                        ...
                        while(!feof($file))
                        {
                            ...
                            if(isset($record_elements[0]) && isset($record_elements[1]))
                            {
                                ...
                                echo "<tr><td align='center' > <input type='radio' name='foodName".$i."' value='".$foodName."'  ></td> "; 
                                 ...
                                 if(file_exists('../../Assets/allFoods/'.$restaurantName."/".$foodName.'.jpg'))
                                 {
                                     echo "<td align='center' ><img src='../../Assets/allFoods/".$restaurantName."/".$foodName.".jpg' width='80px' height='80px'></td> ";
                 
                                 }

                                else{
                                         echo "<td align='center' ><img src='../../Assets/Blank.jpg' width='80px' height='80px'></img></td> "; 
        ...
        echo "<td colspan='2' style='background-color:#FFFFE0;><a href='../../Controllers/logOut.php'><p  style='color:red; font-size:20px;'><b>Log Out<b></p></a></td>";
        echo " </tr>";
