...
fclose($file);
    ...
    echo "<html><head><title>Order History of Customer (".$_COOKIE['username'].") </title></head>";
    echo "<body>";
        
    echo "<fieldset>";
    echo " <legend><p  style='font-size:20px;'>Food Court Management System</p></legend>";
    echo "<table align='center' height='700px' width='800px'  border='1' style='background-color:#FFFFE0;'>";
    echo "<tr><td align='center'><h1>   Your Order History  </h1></td></tr>";
    echo "<tr><td><hr></td></tr>";
                        ...
                        echo "<li><a href='customerChoosingRestaurant.php'>Place Order</a><br></li>";
                                ...
                                // echo "<li><a href='editProfile.php'>Edit Profile</a></li>";
                                 ...
                                 echo "<li><a href='../../Controllers/logOut.php'>LogOut</a></b></li>";
...
echo "<html><head></head><body><table width='500px'  ><tr><th><u>All of Your Past Orders</u></th></tr>";
while(!feof($file))
{
...
if(isset($record_elements[0]) && isset($record_elements[1]) && isset($record_elements[2]))
   { if($record_elements[3]==$username )
    { $total_price=0;
   ...
   // echo " ---(Select : <input type='radio' name='selectedOrder' value='".$record_line_no."' checked>)</th></tr>";
    ...
    echo "<tr><th align='center' width='200px'>Status : </td><td align='center' colspan='3'><b>".$record_elements[2]."</b></td></tr>"; 
...
echo "<th colspan='2'><a href='../../Controllers/logOut.php'><p   style='color:red;background-color:#FFFFE0;' font-size:20px;'><b>Log Out<b></p></a></th>";
echo "</tr>";
