    ...
    <body>
            ...
            { echo "<li><a href='customerReceivingOrder.php'>Recieve Order</a><br></li>";} ?>
                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                        ...
                        <td align="center" >
                        <form method='post' action='../../Controllers/Customer/placeOrder.php' enctype=''>
    <?php
...
$i=0;
$old_order_serial;
$file=fopen('../../Assets/orderSerial.txt','r');
...
$file=fopen('../../Assets/orderSerial.txt','w');
...
while( $i<$j )
{
   if(isset($_POST['foodName'.$i]))
   {
    ...
    echo "<td align='center' ><img src='../../Assets/allFoods/".$restaurantName."/".$foodName.".jpg' width='60px' height='60px'></td>  ";
