                   ...
                   <?php
                    ...
                    <tr>
                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                      ...
                      <tr><td   align="center"  > 
                        <?php  if(isset($_COOKIE["restaurantID"]))
                                    {   if(file_exists("../../Assets/restaurantDP/".$_COOKIE['restaurantID'].".jpg"))
                                                      {echo '<img    style="border:5px solid #000000; padding:3px; margin:5px"; src="../../Assets/restaurantDP/'.trim($_COOKIE['restaurantID']).'.jpg?t='.time().'" height="120px" width="120px"></img><br><br>';} 
                        ...
                        <?php  if(isset($_COOKIE['userid']))
                                    {   if(file_exists("../../Assets/restaurantOwnerDP/".$_COOKIE['userid'].".jpg"))
                                                      {echo '<img    style="border:5px solid #000000; padding:3px; margin:5px"; src="../../Assets/restaurantOwnerDP/'.trim($_COOKIE['userid']).'.jpg?t='.time().'" height="120px" width="120px"></img><br><br>';} 
                     ...
                     <tr> <td colspan="2"> <hr>  </td></tr>
                      ...
                      <tr><td style="padding:10px">User ID:                  </td><td> <b> <?php echo $_COOKIE['userid'];     ?>   </b>     </td></tr>  
                      ...
                      <tr><td style="padding:10px">Restaurant ID:         </td><td> <b> <?php         echo $_COOKIE['restaurantID'];   ?>   </b>     </td></tr>
