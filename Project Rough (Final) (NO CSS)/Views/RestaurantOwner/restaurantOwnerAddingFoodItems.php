                   ...
                   <?php
                    ...
                    <tr>
                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                      ...
                      <form method="post" action="../../Controllers/RestaurantOwner/restaurantOwnerAddingFoodItemsCheck.php" enctype="" >  
                     ...
                     <tr> <td colspan="2"> <hr>  </td></tr>
                      ...
                      <tr><td style="padding:10px">Food Item Name:  </td><td>     <input style="width: 200px; height: 30px;" type="text"     name="foodItemName"  ID="foodItemName"        value=""       placeholder="Food Item Name">  </td></tr> 
                      <tr><td style="padding:10px">Price (Tk.):     </td><td>     <input style="width: 200px; height: 30px;" type="number"   name="foodItemPrice" ID="foodItemPrice"      value="100" placeholder="Food Item Price" min="1"> </td> </tr>
