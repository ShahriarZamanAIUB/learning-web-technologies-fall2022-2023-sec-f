    ...
    <body>
            ...
            <fieldset>
                ...
                <table align="center" height="700px" width="1300px"  border="1">
                    <tr><td align="center"><h1>Admin Searching Restaurants</h1></td></tr>
                    <tr><td><hr></td></tr>
                    ...
                    <tr>
                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                      ...
                      <tr ><th colspan="2" align="center"  > 
                         <br> Search User:  <input type="text"  name="typedText" ID="typedText" onkeyup="searchRestaurantsUsingAJAX()">
                         <input type="button"  name="searchButton" ID="searchButton" value="Search" onclick="searchRestaurantsUsingAJAX()"> <br> </input>
                         </th></tr>
                     ...
                     <tr> <td colspan="2" align="center">  <h2  ID="here"><?php echo showAllRestaurants(); ?></h2>  </td></tr> <!-- Result -->
        ...
        function searchRestaurantsUsingAJAX(){  
            ...
            xhttp.open('POST', '../../Controllers/Admin/adminSearchingRestaurantsCheck.php', true);
