                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                      ...
                      <tr><td colspan="2" align="center"> 
                        <?php  if(isset($_COOKIE['userid']))
                                    {   if(file_exists("../../Assets/customerDP/".$_COOKIE['userid'].".jpg"))
                                                      {echo '<img  style="border:5px solid #000000; padding:3px; margin:5px"; src="../../Assets/customerDP/'.trim($_COOKIE['userid']).'.jpg?t='.time().'" height="120px" width="120px"></img><br><br>';} 
                        ...
                        <form method="POST" action="../../Controllers/Customer/customerDPUploadCheck.php" enctype="multipart/form-data" >
