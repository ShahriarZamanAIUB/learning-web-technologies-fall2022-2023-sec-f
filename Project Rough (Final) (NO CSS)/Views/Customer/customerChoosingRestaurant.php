    ...
    <body>
            ...
            { echo "<li><a href='customerReceivingOrder.php'>Recieve Order</a><br></li>";} ?>
                     ...
                     <li><a href="../../Controllers/logOut.php">LogOut</a></b></li>
                        ...
                        if (filesize('../../Assets/allRestaurantOwners.txt') == 0){
                            // "The file is empty";
                        ...
                        while(!feof($file))
                        {
                            ...
                            if(isset($record_elements[3]) && isset($record_elements[4]))
                            {
                                ...
                                echo "<tr><td align='center' > <input type='radio' name='restaurantName' value='".$restaurantName."'  ></td> "; 
                                 ...
                                 if(file_exists('../../Assets/restaurantDP/'.$restaurantName.'.jpg'))
                                 {
                                     echo "<td align='center' ><img src='../../Assets/restaurantDP/".$restaurantName.".jpg' width='80px' height='80px'></td> ";
